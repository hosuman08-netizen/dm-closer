...
(function(){
  ...
  root.innerHTML='<div class="card"><input id="prod" placeholder="제품/제안"/><input id="who" placeholder="상대 (크리에이터, 사장님…)"/><select id="tone"><option value="friendly">친근</option><option value="pro">프로</option><option value="short">짧고 세게</option></select><button id="go">DM 초안</button><div id="out" class="card" style="margin-top:10px;display:none"></div></div>';
